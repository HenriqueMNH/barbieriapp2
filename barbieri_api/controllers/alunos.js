    ...
    async cadastrarAlunos(request, response) {
        try {
            const {
                ...
                matricula_ano_letivo, ano_curso, observacao = null, eliminacao_data = null, eliminacao_causa = null
            } = request.body;

            const sql = `INSERT INTO alunos (
                aluno_nome, data_nascimento, cidade_natal, nome_pai, nome_mae,
                profissao_pai, nacionalidade_pai, residencia, matricula_primitiva,
                matricula_ano_letivo, ano_curso, observacao, eliminacao_data, eliminacao_causa
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);`;
    ...
    async editarAlunos(request, response) {
        try {
            ...
            const values = [
                aluno_nome, data_nascimento, cidade_natal, nome_pai, nome_mae,
                profissao_pai, nacionalidade_pai, residencia, matricula_primitiva,
                matricula_ano_letivo, ano_curso, observacao, eliminacao_data, eliminacao_causa, id
            ];
